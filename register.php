                    ...
                    <div class="mu-news-single-content" id='tab'>   
                          ...
                          <div class="col-md-6 col-auto">
                              ...
                              <div class="mu-contact-left">
                                <form action="proveraReg.php" method="POST" class="mu-contact-form" id="registracija">
                                  <div class="form-group">
                                   
                                    <input type="text" class="form-control" name='firstname'id="first" placeholder="Firtsname"/><p  id="firstG"></p>
                                  </div>
                                  <div class="form-group">
                                      
                                      <input type="text" class="form-control" name='lastname' id="last" placeholder="Lastname"><p  id="lastG"></p>
                                  </div>
                                  <div class="form-group">
                                   
                                    <input type="text" class="form-control" name='username' id="user" placeholder="Username"><p class="error" id="userG"></p>
                                  </div>                      
                                  <div class="form-group">
                                  
                                    <input type="password" class="form-control" name='password' id="pass" placeholder="Password"><p class="error" id="passG"></p>
                                  </div>
                                  <div class="form-group">
                                     
                                      <input type="password" class="form-control" name='rePassword' id="rePass" placeholder=" Repeat password"><p class="error" id="rePG"></p>
                                  </div>
                                  <div class="form-group">
                                     
                                      <input type="text" class="form-control" name='email' id="mail" placeholder="Email"><p class="error" id="emailG"></p>
                                    </div>          
                                           
                                  <button type="button" class="mu-send-btn" name='btnSend' id='posalji'>Sing up</button>
                                  <div id="feed"></div>
                                </form>
                              </div>
                            </div>
